...
export class CharacterController {
     ...
     */
    update(dt, rig) {
        // Welcome, help, settings and tab switches all pause simulation. A zero
        // step must not reach the acceleration division below: 0 / 0 poisons
        // lean, then camera roll and the entire view-projection matrix.
        if (!(dt > 0)) {
