...
import { moodAt, chordFor, nextMelodyNote, melodyPlacements, mtof } from "./score.js";
...
export class Music {
    ...
    _build() {
        ...
        const pulseSend = ctx.createGain(); pulseSend.gain.value = 0.25;
        this.pulseGain.connect(pulseSend).connect(this.send);
    ...
    update({ hour, nightAmount, speed01, surf, threat, matchRunning, lowHealth, paused }) {
        ...
        this.master.gain.setTargetAtTime(volume * 0.9, t, 0.4);
