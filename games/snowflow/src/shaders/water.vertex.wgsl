...
// billboards are. Sixteen strands share one static buffer and one draw.
//
...
uniform strandParams: array<vec4f, 16>;
...
fn main(input: VertexInputs) -> FragmentInputs {
    ...
    // in use, and the sixteen strands together are sixty-eight thousand vertices
    ...
    // vertices, and the common case is only a few live strands.
