...
export class PostChain {
    ...
    constructor(scene, camera, depth, sky) {
        ...
        this.composite = this._pass("snowTonemap", 1.0,
            ["exposure", "contrast", "mode", "grainAmount", "time", "vignette",
             "speedStreak", "bloomAmount", "shaftAmount", "nightAmount"],
    ...
    _bind() {
        ...
        this.composite.onApply = (e) => {
            ...
            e.setFloat("nightAmount", this.sky.nightAmount);
            ...
            e.setFloat("shaftAmount", S.showLightShafts ? 1 - this.sky.nightAmount : 0);
