...
export const ORES = [
  ['갈색','흔함','흙빛 돌','#996044',-100,3,39.99845],
...
// 운반 칸은 Lv.1(1개)에서 시작해 네 번 강화하면 Lv.5(5개)가 된다.
export const MAX_CARGO=4;
...
const COSTS={strength:s=>Math.round(100*2.1**s.strength),speed:s=>Math.round(100*2**s.speed),cargo:s=>Math.round(4000*6**s.cargo)};
